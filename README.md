...
6. **[terraform-aws-cloudfront](https://github.com/clouddrove/terraform-aws-cloudfront):** Terraform module provisions CloudFront CDN resource on AWS.
...
11. **[terraform-aws-iam-role](https://github.com/clouddrove/terraform-aws-iam-role):** Terraform module to create Iam role resource on AWS.
...
13. **[terraform-aws-acm](https://github.com/clouddrove/terraform-aws-acm):** This terraform module is used for requesting or importing SSL/TLS certificate with validation.
14. **[terraform-aws-labels](https://github.com/clouddrove/terraform-aws-labels):** This terraform module is designed to generate consistent label names and tags for resources. You can use terraform-labels to implement a strict naming convention.
15. **[terraform-aws-vpc](https://github.com/clouddrove/terraform-aws-vpc):** Terraform module to create VPC resource on AWS.
16. **[terraform-aws-subnet](https://github.com/clouddrove/terraform-aws-subnet):** Terraform module to create public, private and public-private subnet with network acl, route table, Elastic IP, nat gateway, flow log.
17. **[terraform-aws-keypair](https://github.com/clouddrove/terraform-aws-keypair):** Terraform module for generating or importing an SSH public key file into AWS.
...
20. **[terraform-aws-cloudtrail](https://github.com/clouddrove/terraform-aws-cloudtrail):** Terraform module to provision an AWS CloudTrail and an encrypted S3 bucket with versioning to store CloudTrail logs
21. **[terraform-aws-lambda](https://github.com/clouddrove/terraform-aws-lambda):**  Terraform module to create Lambda resource on AWS for create lambda function. 
22. **[terraform-aws-alb](https://github.com/clouddrove/terraform-aws-alb):** This terraform module is used to create ALB on AWS.
23. **[terraform-aws-kms](https://github.com/clouddrove/terraform-aws-kms):** This terraform module creates a KMS Customer Master Key (CMK) and its alias.
24. **[terraform-aws-aurora](https://github.com/clouddrove/terraform-aws-aurora):** Terraform module which creates RDS Aurora database resources on AWS and can create different type of databases. Currently it supports Postgres and MySQL.
25. **[terraform-aws-cloudwatch-alarms](https://github.com/clouddrove/terraform-aws-cloudwatch-alarms):** Terraform module creates Cloudwatch Alarm on AWS for monitoriing AWS services.
26. **[terraform-aws-ses](https://github.com/clouddrove/terraform-aws-ses):** Terraform module to create an SES Identity with SES IAM user on AWS.
27. **[terraform-aws-sqs](https://github.com/clouddrove/terraform-aws-sqs):** Terraform module to create SQS resource on AWS for managing queue.
28. **[terraform-aws-vpc-peering](https://github.com/clouddrove/terraform-aws-vpc-peering):** Terraform module to connect two VPC's on AWS.
29. **[terraform-aws-multi-account-peering](https://github.com/clouddrove/terraform-aws-multi-account-peering):** Terraform module to connect two VPC’s from different AWS account.
30. **[terraform-aws-sftp](https://github.com/clouddrove/terraform-aws-sftp):** This terraform module is used to create sftp on AWS for S3.
31. **[terraform-aws-route53](https://github.com/clouddrove/terraform-aws-route53):** Terraform module to create Route53 resource on AWS for zone and record set. 
32. **[terraform-aws-api-gateway](https://github.com/clouddrove/terraform-aws-api-gateway):** Terraform module to create Route53 resource on AWS for create api gateway with it's basic elements.
33. **[terraform-aws-elasticsearch](https://github.com/clouddrove/terraform-aws-elasticsearch):** Terraform module to create an Elasticsearch resource on AWS. 
34. **[terraform-aws-iam-user](https://github.com/clouddrove/terraform-aws-iam-user):** Terraform module to create Iam user resource on AWS.
35. **[terraform-aws-route53-record](https://github.com/clouddrove/terraform-aws-route53-record):** Terraform module to create Route53 table record set resource on AWS. 
36. **[terraform-aws-cloudwatch-event-rule](https://github.com/clouddrove/terraform-aws-cloudwatch-event-rule):** Terraform module to create cloudwatch event rule on AWS.
37. **[terraform-aws-cloudtrail-slack-notification](https://github.com/clouddrove/terraform-aws-cloudtrail-slack-notification):** Terraform module to create Lambda resource on AWS for sending notification when anything done from console in AWS. 
38. **[terraform-aws-secure-baseline](https://github.com/clouddrove/terraform-aws-secure-baseline):** Terraform module to create an Secure Basline, inclued module is alarm baseline, config baseline, and clouddtrail baseline.
39. **[terraform-digitalocean-ssh-key](https://github.com/clouddrove/terraform-digitalocean-ssh-key):** Provides a DigitalOcean SSH key resource to allow you to manage SSH keys for Droplet access.
40. **[terraform-digitalocean-labels](https://github.com/clouddrove/terraform-digitalocean-labels):**   This terraform module is designed to generate consistent label names and tags for resources. You can use terraform-labels to implement a strict naming convention.
41. **[terraform-digitalocean-vpc](https://github.com/clouddrove/terraform-digitalocean-vpc):**  VPCs are virtual networks containing resources that can communicate with each other in full isolation, using private IP addresses
42. **[terraform-digitalocean-droplet](https://github.com/clouddrove/terraform-digitalocean-droplet):** Provides a DigitalOcean Droplet resource. This can be used to create, modify, and delete Droplets.
43. **[terraform-digitalocean-firewall](https://github.com/clouddrove/terraform-digitalocean-firewall):** Provides a DigitalOcean Cloud Firewall resource. This can be used to create, modify, and delete Firewalls.
44. **[terraform-digitalocean-certificate](https://github.com/clouddrove/terraform-digitalocean-certificate):** Provides a DigitalOcean Certificate resource that allows you to manage certificates.
45. **[terraform-aws-ecs](https://github.com/clouddrove/terraform-aws-ecs):** Terraform module to create ECS on AWS.
46. **[terraform-aws-lambda-site-monitor](https://github.com/clouddrove/terraform-aws-lambda-site-monitor):** Terraform module to create Lambda resource on AWS for monitor different websites.
47. **[terraform-aws-mysql](https://github.com/clouddrove/terraform-aws-mysql):** Terraform module to create a MySQL on AWS.
48. **[terraform-aws-ec2-autoscaling](https://github.com/clouddrove/terraform-aws-ec2-autoscaling):** Terraform module will be created EC2 modulewith Autoscaling group.
49. **[terraform-aws-node-group](https://github.com/clouddrove/terraform-aws-node-group):** This terraform module is used to create a node group for EKS.
50. **[terraform-aws-lightsail](https://github.com/clouddrove/terraform-aws-lightsail):** Terraform module to create Lightsail instance, Lightsail Key Pair (Optional), Lightsail Static IP (Optional), Metric alarm (Optional).
51. **[terraform-aws-secrets-manager](https://github.com/clouddrove/terraform-aws-secrets-manager):** Terraform module to create Secret Manager resource on AWS for manage our secret variables.
52. **[terraform-aws-cognito](https://github.com/clouddrove/terraform-aws-cognito):** Terraform module to create an Cognito resource on AWS.
53. **[terraform-aws-workspace](https://github.com/clouddrove/terraform-aws-workspace):** Terraform module to create workspace resources on AWS for manage betterly.
54. **[terraform-aws-active-directory](https://github.com/clouddrove/terraform-aws-active-directory):** Terraform module to create Active Directory on AWS.
55. **[terraform-aws-reference-architecture](https://github.com/clouddrove/terraform-aws-reference-architecture):** This repo is used as a sample refrence architecture to manage internal projects terraform.
